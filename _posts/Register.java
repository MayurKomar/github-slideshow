...
public class Register extends AppCompatActivity {
    ...
    public void registerButton(View view) {
        ...
        UserInfo user = new UserInfo(HotelName, email, password, phone, room, price,Lat,Long,city);

        reference.child(HotelName).setValue(user).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
